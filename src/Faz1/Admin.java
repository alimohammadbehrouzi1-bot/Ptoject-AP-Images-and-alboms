...
public class Admin {
    ...
    public void banOrUnbanUser(User user,boolean condition)throws Exception{
        for(User u: allUsers){
            if(u.equals(user)){
                ...
                if (condition){
                    System.out.println(user.getUsername()+" is unbaned now");
                }
                else {
                    System.out.println(user.getUsername()+" is baned now");
                }
                return;
            }
        }
    ...
    public void printUsetInfo(User user) throws Exception{
        for(User u:allUsers){
            if (u.equals(user)){
